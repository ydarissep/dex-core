...
window.speciesPanelLocationsButton = document.getElementById("speciesPanelLocationsButton")
window.speciesPanelInfoButton = document.getElementById("speciesPanelInfoButton")
